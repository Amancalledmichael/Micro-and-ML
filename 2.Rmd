...
```{r}
margins(trunc)
labsupp_working <- labsupp[labsupp$inlf == 1,]

trunccond <- truncreg(hours ~ kidslt6 + kidsge6 + age + educ + faminc + city + exper + expersq, data = labsupp_working)
margins(trunccond)

trunc_working <- trunc
trunc_working$model <- trunc_working$model[trunc_working$model$hours > 0,]



margins(trunc_working)
summary(trunc_working)
