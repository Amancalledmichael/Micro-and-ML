...
The value-added of estimating a partial linear model is lies in reduced noise when estimating a high-dimensional regression. Below we can see that in a naive OLS with the extended set of regressors, the confidence interval is slightly wider than in the double ML regressions.
