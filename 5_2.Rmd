...
vcov_lasso <- vcovHC(alpha_lasso, type = "HC")
vcov_lasso[[1]]
...
CI_lasso <- calc_CI(alpha_lasso$coefficients[["residuals_suppins"]], vcov_lasso[[1]], nrow(health_extend))

stargazer(alpha_lasso, type = "text", keep = "residuals_suppins", ci = TRUE,
          omit.stat = "all")
```
...
vcov_tree <- vcovHC(alpha_tree, type = "HC0")

stargazer(alpha_tree, type = "text", keep = "residuals_f2_tree", ci = TRUE,
          omit.stat = "all")
```
